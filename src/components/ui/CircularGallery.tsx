...
// Type definitions to satisfy TS
type GLContext = OGLRenderingContext;
...
function createTextTexture(gl: GLContext, text: string, font = 'bold 30px monospace', color = 'black') {
